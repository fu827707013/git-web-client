...
**架构模式**：前后端分离，支持 Electron 桌面应用和 Web 应用两种模式
...
- ✅ 按作者筛选
- ✅ 单个提交下载
- ✅ 批量提交下载（多选 + Shift 范围选择）
- ✅ 右键菜单快捷操作（查看详情、下载、复制 SHA）

### 📁 文件详情
- ✅ 树形目录结构展示
- ✅ 文件状态可视化（Added、Modified、Deleted、Renamed 等）
- ✅ 递归文件夹展开/折叠
- ✅ 全部展开/折叠控制
- ✅ 文件搜索过滤
- ✅ 变更文件统计
...
│   ├── Program.cs            # 启动入口
│   └── ...
├── ELECTRON_INTEGRATION.md    # Electron 集成技术文档
└── README.MD                  # 本文档
```
